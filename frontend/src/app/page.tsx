...
import { getAvailableGenomes, getGenomeChromosomes, searchGenes, type ChromosomeFromSearch, type GeneFromSearch, type GenomeAssemblyFromSearch} from "~/utils/genome-api";
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              <h1 className="text-xl font-light tracking-wide text-[#3c4f3d]">
                <span className="font-normal">Mut</span>
                <span className="text-[#b20000]">AI</span>
                <span className="font-normal">on</span>
              </h1>
              <div className="absolute -bottom-1 left-0 h-[2px] w-20 bg-[#de8246]"></div>
            </div>
            <span className="text-sm font-light text-[#3c4f3d]/70">
              Variant Analysis with LLM
            </span>
          </div>
        </div>
      </header>
              ...
              <CardContent className="pb-4">
                ...
                >
                  ...
                  <SelectContent className="cursor-pointer">
                    {genomes.map((genome) => (
                      <SelectItem key={genome.id} value={genome.id} className="cursor-pointer">
